...
var skel = function () {
    var a = {
        ...
        getLevel: function (a) {
            return "boolean" == typeof a ? a ? 1 : 0 : parseInt(a)
        },
        ...
        attachElements: function (b) {
            ...
            0 < c.length && a.DOMReady(function () {
                a.iterate(c, function (b) {
                    if (e = a.locations[c[b].location])if (e._skel_attach(c[b].object), c[b].onAttach)c[b].onAttach()
                })
            })
        },
        poll: function () {
        ...
        initUtilityMethods: function () {
            (function () {
                var b = window, d = function (a) {
                    ...
                    a = !1;
                    if (!e)if (e = !0, "loading" !== c.readyState && h(), c.addEventListener)c.addEventListener("DOMContentLoaded",
            ...
            a.indexOf = Array.prototype.indexOf ? function (a, d) {
                ...
                e = this.length;
                if (0 === e || c >= e)return -1;
                for (0 > c && (c = e - Math.abs(c)); c < e; c++)if (this[c] === a)return c;
                return -1
            };
